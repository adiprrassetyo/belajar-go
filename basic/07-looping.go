...
func main() {
	...
	*/
	...
	for i := 1; i <= 10; i++ {
    if i % 2 == 1 {
        continue // jika nilai i adalah bilangan ganjil, maka perulangan akan dilanjutkan ke iterasi selanjutnya (continue)
    }

    if i > 8 {
        break // jika nilai i adalah 9, maka perulangan akan dihentikan (break)
    }

    fmt.Println("Angka", i)// Jika nilai i adalah bilangan genap, maka perintah fmt.Println("Angka", i) akan dijalankan.
